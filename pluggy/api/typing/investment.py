...
INVESTMENT_SUBTYPES = MUTUAL_FUND_INVESTMENT_SUBTYPES + SECURITY_INVESTMENT_SUBTYPES + EQUITY_INVESTMENT_SUBTYPES + FIXED_INCOME_INVESTMENT_SUBTYPES + COE_INVESTMENT_SUBTYPES + ['OTHER']
...
InvestmentTransactionType = Literal[
    'BUY',
    'SELL',
    'TAX',
    'TRANSFER'
